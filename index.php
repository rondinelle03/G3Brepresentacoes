			...
			<div class="row">
				...
				<div class="col s12 det-top">
					<ul class="flag-ico">
						...
						<li><a href="english.php"><img src="imgs/ico-ingles.png"></a></li>
						<li><a href="spain.php"><img src="imgs/ico-spain.png"></a></li>
					</ul>
...
Castanha de Caju e Castanha do Pará</p>

<p><strong>Combustíveis:</strong><br>
JET FUEL A1, GASOLINA TIPO A E TIPO C, DIESEL</p>
...
Manganês, Magnetita, Nióbio e Titânio</p>
    ...
    <div class="modal-footer">
      <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat">Fechar</a>
							...
							<h3>Faça sua Cotação</h3>
							    ...
							    <form class="col s12" action="" method="post">
							      <div class="row">
							        ...
							        <div class="input-field col s12">
							          <input id="last_name" type="text" name="telefone" class="validate">
        ...
        <footer id="rodape">
           ...
           <?php
            require_once('/home/g3b/public_html/libs/phpmailer/class.phpmailer.php');
            require_once('/home/g3b/public_html/libs/phpmailer/class.smtp.php');
            sleep(1);
            ...
            if(!empty($_POST)) {
                if($_POST['cat'] == 1) {
                    ...
                    $mailer->FromName = 'G3B';
                    $mailer->From = 'g3b@g3b.com.br';
                    $mailer->AddAddress('g3b@g3b.com.br', 'Cotação G3B');
                    $mailer->Subject = 'Cotação - G3B';
                    ...
                    <td width="480" align="center" bgcolor="#000000" style=" padding: 15px; font-family: Verdana, Geneva, sans-serif; color: #FFF; font-weight: bold;">FORMULÁRIO DE COTAÇÃO - G3B</td>
                    </tr>
                    <tr>
                    <td colspan="2" style="padding: 20px; font-family: Arial; color: #666; font-weight: bold; text-align: justify;">
                    Olá,
                    <br /><br />Esta é uma mensagem automática para notificar um contato - G3B.
                    <br /><br />
                    </td>
                    </tr>
                    <tr>
                    ...
                    $mailer->Password = 'Acbnatal22';
                    $mailer->FromName = 'G3B';
                    $mailer->AddAddress('g3b@g3b.com.br', 'Contato G3B');
                    $mailer->Subject = 'Fale Conosco - G3B';
                    $mailer->Body = '<center><table width="700" border="1" cellpadding="0" cellspacing="0" style="border: 1px #000000 solid; border-collapse: collapse;">
                    <tr>
                    <td style="padding: 5px;" bgcolor="#FFF" style="border: 0 !important; bordercolor: #FFF;"  width="210" align="center" ></td>
                    <td width="480" align="center" bgcolor="#000000" style=" padding: 15px; font-family: Verdana, Geneva, sans-serif; color: #FFF; font-weight: bold;">FORMULÁRIO DE CONTATO - G3B</td>
                    </tr>
                    <tr>
                    <td colspan="2" style="padding: 20px; font-family: Arial; color: #666; font-weight: bold; text-align: justify;">
                    Olá,
