        ...
        <div class="container">
			<div class="row">
				...
				<div class="col s12 det-top">
					<ul class="flag-ico">
						<li><a href="index.php"><img src="imgs/ico-brazil.png"></a></li>
         ...
         <?php
            ...
            if(!empty($_POST)) {
                if($_POST['cat'] == 1) {
                    ...
                    $mailer->AddAddress('g3b@g3b.com.br', 'Cotação G3B (ENGLISH)');
                    $mailer->Subject = 'Cotação - G3B (ENGLISH)';
                    ...
                    $mailer->Password = 'Acbnatal22';
                    $mailer->FromName = 'G3B';
                    $mailer->AddAddress('g3b@g3b.com.br', 'Contato G3B (ENGLISH)');
                    $mailer->Subject = 'Fale Conosco - G3B (ENGLISH)';
                    $mailer->Body = '<center><table width="700" border="1" cellpadding="0" cellspacing="0" style="border: 1px #000000 solid; border-collapse: collapse;">
                    <tr>
                    <td style="padding: 5px;" bgcolor="#FFF" style="border: 0 !important; bordercolor: #FFF;"  width="210" align="center" ></td>
